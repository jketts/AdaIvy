...
- **Status:** accepted for the bounded spike; implemented and merged 21 August
  2026. No engine is adopted into production Phase 5.
- **Date:** 2026-08-21
...
2. **The exact check is the only arbiter.** A case's disposition is derived only
   ...
   (`comparison_validator.validate_fixture`) and/or the exact algebraic reconstruction.
...
What remains canonical for this experiment: `comparison_validator.py` as its
preserved file-based baseline and
`fixtures/phase5-noncommuting-sdp/comparison-small-cases-v1.json` as its frozen
three-case fixture. The expanded ADR-0033 fixture remains canonical for that
separate exact-certificate spike. The
exact checks remain authoritative. What may be delegated: the numerical search
