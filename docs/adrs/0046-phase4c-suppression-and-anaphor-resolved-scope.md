...
- **Status:** accepted and implemented for the bounded Phase 4C successor slice
  on 21 August 2026, all seven gates met -- see "Measured outcome"; partially
  supersedes ADR-0031 (the demotion-only constraint and the sentence scope
  unit). Filed as 0046: drafted as 0032 while that number looked free, and
  renumbered on merge with no change to its content, exactly as this record
  required.
- **Date:** 2026-08-21
