#!/usr/bin/env python3
"""Scan persisted gate/project evidence without printing credential values."""
...
OUTPUT = Path(__file__).with_name("credential-scan-v4.json")
TOKEN_PATTERNS = (
...
def main() -> int:
    ...
    report = {
        "schema_version": "adaivy.credential-scan.v4",
