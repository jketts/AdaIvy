...
from spikes.phase5_noncommuting_sdp import algebraic as alg
...
from spikes.phase5_noncommuting_sdp.validator import CertificateInputError, validate_fixture

REPO_ROOT = Path(__file__).resolve().parents[1]
SPIKE_ROOT = REPO_ROOT / "spikes" / "phase5_noncommuting_sdp"
FIXTURE = REPO_ROOT / "fixtures" / "phase5-noncommuting-sdp" / "exact-small-cases.json"
